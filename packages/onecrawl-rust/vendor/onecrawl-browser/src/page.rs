...
use onecrawl_protocol::cdp::js_protocol;
...
use onecrawl_protocol::cdp::{browser_protocol, IntoEventKind};
...
impl Page {
    ...
    /// # use onecrawl_browser::error::Result;
    /// # use onecrawl_browser::layout::Point;
    /// # use onecrawl_protocol::cdp::browser_protocol::input::{DispatchMouseEventParams, MouseButton, DispatchMouseEventType};
    /// # async fn demo(page: Page, point: Point) -> Result<()> {
    ///      // double click
