...
action_enum!(AgentAction, "agent", [
    ...
    AndroidConnect => "android_connect",
    AndroidNavigate => "android_navigate",
    AndroidTap => "android_tap",
    AndroidSwipe => "android_swipe",
    AndroidLongPress => "android_long_press",
    AndroidDoubleTap => "android_double_tap",
    AndroidPinch => "android_pinch",
    AndroidType => "android_type",
    AndroidFind => "android_find",
    AndroidClick => "android_click",
    AndroidScreenshot => "android_screenshot",
    AndroidOrientation => "android_orientation",
    AndroidKey => "android_key",
    AndroidAppLaunch => "android_app_launch",
    AndroidAppKill => "android_app_kill",
    AndroidAppState => "android_app_state",
    AndroidInstall => "android_install",
    AndroidScript => "android_script",
    AndroidShell => "android_shell",
    AndroidPush => "android_push",
    AndroidPull => "android_pull",
    AndroidInfo => "android_info",
    AndroidBattery => "android_battery",
    AndroidUrl => "android_url",
    AndroidTitle => "android_title",
