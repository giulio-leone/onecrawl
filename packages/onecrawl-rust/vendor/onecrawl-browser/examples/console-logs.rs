...
use onecrawl_browser::{cdp::js_protocol::runtime::EventConsoleApiCalled, BrowserConfig};
...
async fn main() {
    ...
    let (mut browser, mut handler) =
        onecrawl_browser::Browser::launch(BrowserConfig::builder().with_head().build().unwrap())
            .await
