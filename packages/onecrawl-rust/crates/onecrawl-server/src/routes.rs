...
pub fn create_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/tabs/{tab_id}/lock", post(lock_tab))
        .route("/tabs/{tab_id}/lock", delete(unlock_tab))
        .route("/tabs/{tab_id}/lock", get(get_tab_lock))
        .layer(cors)
...
#[derive(serde::Deserialize)]
struct LockTabRequest {
    owner: String,
    ttl_secs: Option<u64>,
}

#[derive(serde::Deserialize)]
struct UnlockTabRequest {
    owner: String,
}
