...
//! use onecrawl_browser::{Browser, BrowserConfig};
//!
//! #[tokio::main]
...
//! ```
//!
//! The [`onecrawl_protocol_gen`] crate contains a [PDL
//! parser](onecrawl_protocol_gen/src/pdl/parser.rs), which is a rust rewrite of a
...
//! [`Generator`](onecrawl_protocol_gen/src/build/generator.rs) that turns the
//! parsed PDL files into rust code. The
//! [`onecrawl_protocol`](onecrawl_protocol) crate only purpose is to integrate
...
pub use onecrawl_protocol::cdp;
pub use onecrawl_browser_types::{self as types, Binary, Command, Method, MethodType};
...
#[cfg(feature = "fetcher")]
pub mod fetcher {
    pub use onecrawl_browser_fetcher::*;
}
