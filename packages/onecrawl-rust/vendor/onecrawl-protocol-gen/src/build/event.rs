    ...
    pub fn build(self) -> TokenStream {
        ...
        let event_impl = quote! {
            ...
            pub struct CdpEventMessage {
                /// Name of the method
                pub method: onecrawl_browser_types::MethodId,
                /// The chromium session Id
                pub session_id: Option<String>,
                /// Json params
                pub params: CdpEvent,
            }
            impl onecrawl_browser_types::Method for CdpEventMessage {
            ...
            impl onecrawl_browser_types::EventMessage for CdpEventMessage {
        ...
        let deserialize_impl = quote! {
            ...
            impl std::convert::TryInto<onecrawl_browser_types::CdpJsonEventMessage> for CdpEventMessage {
                type Error = serde_json::Error;

                fn try_into(self) -> Result<onecrawl_browser_types::CdpJsonEventMessage, Self::Error> {
                    use onecrawl_browser_types::Method;
                    Ok(onecrawl_browser_types::CdpJsonEventMessage {
